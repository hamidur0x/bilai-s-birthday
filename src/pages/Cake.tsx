...
export default function Cake() {
  ...
  const blowCandles = () => {
    ...
    setTimeout(() => setShowWish(false), 3500);
  };
    ...
    <div style={{ 
      ...
      {showWish && (
        <div style={{
          ...
          <h2 className="font-handwritten" style={{ fontSize: '2.2rem', color: '#d4739d' }}>
            🎉 Happy Birthday! 🎉
          </h2>
          <p style={{ color: '#5c3d3d', fontSize: '1.1rem' }}>Make a wish, Pookie! ✨💕</p>
        </div>
      )}
      ...
      {!showAR && (
        <main style={{ 
          ...
          >
            <CandleWithFlame lit={candlesLit} />
            <CakeSVG />
          </div>
          ...
          <div style={{ 
            ...
            <p style={{ fontSize: '1.3rem', fontWeight: 600, color: '#d4739d' }}>
              Pookie 💕
            </p>
          </div>
          ...
          <button
            ...
            style={{
              ...
              gap: '0.5rem',
              cursor: 'pointer',
              boxShadow: '0 4px 20px rgba(232, 164, 201, 0.4)',
              marginTop: '2rem',
        ...
        <div style={{
          ...
          >
            <div style={{ position: 'relative', width: '200px', height: '500px' }}>
              <CandleWithFlame lit={candlesLit} instant />
              <CakeSVG static />
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ textAlign: 'center', fontWeight: 600, marginBottom: '1rem', color: '#5c3d3d' }}>
                ✨ Tap the cake to blow candles! ✨
              </p>
              <button
                onClick={closeCamera}
                style={{
                  width: '100%',
                  background: 'linear-gradient(135deg, #e8a4c9, #d4739d)',
                  color: '#fff',
                  border: 'none',
                  borderRadius: '1rem',
                  padding: '0.875rem',
...
function CandleWithFlame({ lit, instant }: { lit: boolean; instant?: boolean }) {
  return (
    <div style={{
      background: '#ffffff',
      borderRadius: '10px',
      ...
      width: '5px',
      height: '35px',
      transform: instant ? 'translateY(0)' : 'translateY(-300px)',
      animation: instant ? 'none' : 'candleIn 500ms 6s ease-out forwards'
    }}>
      {/* Stripe decorations */}
      <div style={{
        position: 'absolute',
      ...
      {lit && [1, 2, 3, 4, 5].map((i) => (
        <div
          ...
          style={{
            ...
            width: '6.67px',
            height: '18px',
            animation: `fuego ${2 / i}s ${instant ? '0s' : '6.5s'} infinite`
          }}
        />
      ))}
    </div>
...
function CakeSVG({ static: isStatic }: { static?: boolean }) {
  if (isStatic) {
    return (
      <svg version="1.1" width="200px" height="500px" viewBox="0 0 200 500">
        <path fill="#a88679" d="M173.667,427.569c-49.795,0-101.101,0-147.334,0c-3.999,0-4-16.002,0-16.002c46.385,0,97.539,0,147.334,0C177.668,411.567,177.667,427.569,173.667,427.569z"/>
        ...
        <path fill="#a88679" d="M173.667,451.394c-49.298,0-102.782,0-147.334,0c-3.999,0-4-16.002,0-16.002c44.697,0,96.586,0,147.334,0C177.667,435.392,177.668,451.394,173.667,451.394z"/>
        <path fill="#8b6a60" d="M173.667,451.394c2.875,0,2.997,9.257,0,9.131c-22.662-0.956-32.09-0.956-41.756-0.956c-14.48,0-17.884,0-30.163,0c-2.087,0-2.068,0-3.915,0c-13.333,0-8.963,0-23.088,0c-11.668,0-34.99-0.294-48.412,1.831c-4.109,0.65-3.01-10.006,0-10.006C37.129,451.394,149.379,451.394,173.667,451.394z"/>
        <path fill="#a88679" d="M173.667,475.571c-46.512,0-105.486,0-147.334,0c-3.999,0-4-16.002,0-16.002c43.566,0,97.96,0,147.334,0C177.667,459.569,177.666,475.571,173.667,475.571z"/>
  ...
  return (
    <svg id="cake" version="1.1" width="200px" height="500px" viewBox="0 0 200 500">
      <path fill="#a88679" d="M173.667-13.94c-49.298,0-102.782,0-147.334,0c-3.999,0-4-16.002,0-16.002c44.697,0,96.586,0,147.334,0C177.667-29.942,177.668-13.94,173.667-13.94z">
        <animate id="bizcocho_3" attributeName="d" calcMode="spline" keySplines="0 0 1 1; 0 0 1 1" begin="relleno_2.end" dur="0.3s" fill="freeze" values="M173.667-13.94c-49.298,0-102.782,0-147.334,0c-3.999,0-4-16.002,0-16.002c44.697,0,96.586,0,147.334,0C177.667-29.942,177.668-13.94,173.667-13.94z;M173.667,411.567c-47.995,12.408-102.955,12.561-147.334,0c-3.848-1.089-0.189-16.089,3.661-15.002c44.836,12.66,90.519,12.753,139.427,0.07C173.293,395.631,177.541,410.566,173.667,411.567z;M173.667,427.569c-49.795,0-101.101,0-147.334,0c-3.999,0-4-16.002,0-16.002c46.385,0,97.539,0,147.334,0C177.668,411.567,177.667,427.569,173.667,427.569z" />
      </path>
      <path fill="#8b6a60" d="M100-178.521c1.858,0,3.364,1.506,3.364,3.363c0,0,0,33.17,0,44.227c0,19.144,0,57.431,0,76.574c0,10.152,0,40.607,0,40.607c0,1.858-1.506,3.364-3.364,3.364l0,0c-1.858,0-3.364-1.506-3.364-3.364c0,0,0-30.455,0-40.607c0-19.144,0-57.432,0-76.575c0-11.057,0-44.226,0-44.226C96.636-177.015,98.142-178.521,100-178.521L100-178.521z">
      ...
      <path fill="#a88679" d="M173.667-15.929c-46.512,0-105.486,0-147.334,0c-3.999,0-4-16.002,0-16.002c43.566,0,97.96,0,147.334,0C177.667-31.931,177.666-15.929,173.667-15.929z">
      ...
      <path fill="#8b6a60" d="M101.368-73.685c0,12.164,0,15.18,0,28.519c0,22.702,0-13.661,0,8.304c0,14.48,0,18.233,0,30.512c0,1.753-2.958,1.847-2.958,0c0-12.68,0-16.277,0-30.401c0-21.983,0,11.66,0-8.305c0-13.027,0-15.992,0-28.628C98.411-75.883,101.368-75.592,101.368-73.685z">
      ...
      <path fill="#a88679" d="M173.667,21.571c-33.174,0-111.467,0-147.334,0c-4,0-4-16.002,0-16.002c39.836,0,105.982,0,147.334,0C177.668,5.569,177.667,21.571,173.667,21.571z">
...
function createConfetti() {
  ...
  const colors = ['#e8a4c9', '#ffd1dc', '#ffb6c1', '#ff69b4', '#fff', '#ffc0cb'];
  const shapes = ['❤️', '💕', '🎉', '✨', '🎂', '💖'];
